...
namespace EMNDC.Preposicionamiento.Migrations
{
    ...
    [Migration("20260416183457_UpdateModelMuncipioProvincia")]
    partial class UpdateModelMuncipioProvincia
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EMNDC.Preposicionamiento.Models.Producto", b =>
                {
                    ...
                    b.Property<DateTime>("Almacenado")
                        .HasColumnType("datetime(6)");
                    ...
                    b.Property<string>("UnidadMedidas")
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("EMNDC.Preposicionamiento.Models.Address", b =>
                {
                    ...
                    b.HasOne("EMNDC.Preposicionamiento.Models.Posicionamiento", "Posicionamiento")
                        .WithMany()
                        .HasForeignKey("PosicionamientoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EMNDC.Preposicionamiento.Models.Almacen", b =>
                {
                    b.HasOne("EMNDC.Preposicionamiento.Models.Address", null)
                        .WithMany("Almacens")
